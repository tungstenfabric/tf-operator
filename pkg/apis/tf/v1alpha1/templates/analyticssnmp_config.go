...
// AnalyticsSnmpNodemanagerConfig is the template of the Analytics Snmp Nodemanager service configuration.
var AnalyticsSnmpNodemanagerConfig = htemplate.Must(htemplate.New("").Funcs(sprig.FuncMap()).Parse(`
[DEFAULTS]
http_server_ip={{ .InstrospectListenAddress }}
log_file={{ default "/var/log/contrail/contrail-analyticssnmp-nodemgr.log" .LogFile }}
log_level={{ default "SYS_INFO" .LogLevel }}
log_local={{ default "1" .LogLocal }}
hostname={{ .Hostname }}
...
// AnalyticsSnmpVncConfig is a template for vnc_api.ini file
var AnalyticsSnmpVncConfig = htemplate.Must(htemplate.New("").Funcs(sprig.FuncMap()).Parse(`
[global]
